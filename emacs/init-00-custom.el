(custom-set-variables
 ...
 '(package-selected-packages
   '(adoc-mode age ajrepl alert apheleia auto-read-only auto-virtualenvwrapper avy
               avy-flycheck bind-key browse-kill-ring caddyfile-mode cargo
               cmake-mode coffee-mode company company-org-block counsel
               crossword cython-mode dash deadgrep defproject dfmt diminish
               dired-collapse dired-subtree d-mode dockerfile-mode dtrt-indent
               dumb-jump editorconfig eldoc elixir-mode emojify evil-numbers
               expand-region faceup fennel-mode fish-mode flycheck flycheck-mypy
               flycheck-nim flycheck-package flycheck-plantuml flycheck-pos-tip
               flyspell git-link git-modes go-add-tags godoctor go-eldoc go-guru
               go-mode google-translate go-rename goto-addr goto-last-change
               graphviz-dot-mode guess-language helpful hl-todo hydra hy-mode
               ibuffer-projectile ivy ix janet-ts-mode jinja2-mode jq-mode
               js2-mode js-doc just-mode less-css-mode list-utils loop lsp-mode
               lsp-pyright lsp-ui lua-mode magit magit-todos markdown-mode
               memory-usage move-text multiple-cursors nim-mode nix-mode notmuch
               org org-contrib org-mime ox-gfm ox-md package-lint
               parinfer-rust-mode php-mode pkgbuild-mode plantuml-mode po-compat
               po-mode projectile pueue python rainbow-mode restclient
               restclient-jq ripgrep rust-mode s sass-mode scad-mode scss-mode
               shrink-whitespace sly sly-asdf sly-named-readtables sly-quicklisp
               smart-comment smart-forward smart-mode-line smerge-mode sudoku
               swiper systemd tide toml-mode transpose-frame treesit-auto
               undo-tree unicode-troll-stopper use-package uuidgen viking-mode
               visual-fill-column volatile-highlights vterm web-mode wgrep
               which-key writeroom-mode wttrin xref yaml-mode yasnippet
               zenburn-theme) nil nil "COUCOU!")
