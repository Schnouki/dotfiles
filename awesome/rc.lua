...
screenmenu = {
    ...
    { "abo&ve", "xrandr --output LVDS-1 --auto --output " .. ext_screen .. " --auto --above LVDS-1" },
    { "&below", "xrandr --output LVDS-1 --auto --output " .. ext_screen .. " --auto --below LVDS-1" },
...
mymainmenu = awful.menu({ items = { { "&awesome", myawesomemenu, beautiful.awesome_icon },
                                    ...
                                    menu_sep,
                                    { "s&potify", safe_cmd("spotify"), icon_theme.get("apps", "spotify") },
...
persokeys = {
   ...
   awful.key({ }, "XF86ScreenSaver",      function () awful.spawn("xautolock -locknow") end),
   awful.key({ modkey, "Control" }, "F2", function () awful.spawn("xautolock -locknow") end,
